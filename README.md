...
* **BSG_GAMLSS.R:** computational implementation of the GBS distribution within the architecture of the R package gamlss.
...
* **SE_Estimates_Scenario_1_n40.txt, SE_Estimates_Scenario_1_180.txt, SE_Estimates_Scenario_1_n160.txt, SE_Estimates_Scenario_1_n320.txt:** standard error of maximum likelihood estimates of the regression coefficients for all sample sizes considered.
* **SAMPLE.R:** R script that generates the design matrices and the response variable.
* **BSG_GAMLSS.R:** computational implementation of the GBS distribution within the architecture of the gamlss R package.
